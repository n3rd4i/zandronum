...
$url        = 'https://zandronum.com/downloads/zandronum3.0-win32-base.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'zandronum*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
